...
parser.add_argument('--croppedTSV', default='/mnt/sata/data/MS-Celeb-1M/data/aligned_face_images/'
                                            'FaceImageCroppedWithAlignment.tsv', type=str)
parser.add_argument('--outputDir', type=str, default='/mnt/sata/data/MS-Celeb-1M/data/aligned_face_images/raw')
