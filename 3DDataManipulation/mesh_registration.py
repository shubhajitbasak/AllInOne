...
if __name__ == "__main__":
    ...
    parser.add_argument('--MICC_path', default=r'D:\Project2(2Dto3D)\Data\FlorenceFace', help='Original directory of '
                                                                                              'the MICC FLORENCE '
                                                                                              'dataset')
    parser.add_argument('--save_path', default=r'D:\Project2(2Dto3D)\Data\FlorenceFaceRegister', help='Path to save '
                                                                                                      'registration '
                                                                                                      'of the dataset')
    parser.add_argument('--landmarks', default='MICC_landmarks', help='Manually labelled ibug68 landmarks of the MICC '
                                                                      'dataset')
